...
Partial Class AdminProduk
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(AdminProduk))
        Panel12 = New Panel()
        ...
        ' Panel5
        ' 
        Panel5.BackColor = Color.FromArgb(CByte(109), CByte(139), CByte(116))
        ...
        LblProduk.ForeColor = Color.WhiteSmoke
        ...
        ' Panel14
        ' 
        Panel14.Controls.Add(DgvProduk)
        ...
        DgvProduk.Size = New Size(1003, 282)
        ...
        Label2.TabIndex = 1
        Label2.Text = "Menampilkan semua  produk pada sistem MyKantinku."
        ' 
        ' Label7
        ' 
